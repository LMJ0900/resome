...
import StartAni from "@/components/ggunPr/startAni/page";
import LoginBar from "@/components/ggunPr/login/login";
import JoinBar from "@/components/ggunPr/join/joinBar";
